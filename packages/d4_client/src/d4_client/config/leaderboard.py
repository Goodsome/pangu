...
class LeaderboardConfig:
    ...
    leaderboard: LeaderboardLayoutConfig
...
def _parse_slot_list(raw: Any) -> list[SlotConfig]:
    return [SlotConfig(name=str(s["name"]), hover=_parse_point(s["hover"])) for s in raw]


def _parse_leaderboard_layout(raw: Any) -> LeaderboardLayoutConfig:
