...
class BaseTypeEdgeMapper(BaseEdgeMapper):

    @staticmethod
    def to_dto(edge_model: CodeEdgeModel, direction: EdgeDirection) -> BaseTypeEdge:
        return BaseTypeEdge(
    ...
    @staticmethod
    def to_properties(dto: BaseTypeEdge) -> dict[str, Any]:
        return {}
