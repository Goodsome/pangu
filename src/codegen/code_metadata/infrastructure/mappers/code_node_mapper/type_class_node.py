"""TypeClassNode 的三向转换（ORM ↔ Domain ↔ DTO）。"""
...
class TypeClassNodeMapper:
    """TypeClassNode 专属的三向 Mapper。"""

    @classmethod
    def to_dto(cls, orm_model: TypeClassNodeModel) -> TypeClassNode:
        return TypeClassNode(
            id=orm_model.fqn,
            name=orm_model.name,
    ...
    @classmethod
    def to_properties(cls, dto: TypeClassNode) -> dict[str, Any]:
        return {}
