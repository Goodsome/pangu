"""UnionTypeNode 的三向转换（ORM ↔ Domain ↔ DTO）。"""
...
class UnionTypeNodeMapper:
    """UnionTypeNode 专属的三向 Mapper。"""

    @classmethod
    def to_dto(cls, orm_model: UnionTypeNodeModel) -> UnionTypeNode:
    ...
    @classmethod
    def to_properties(cls, dto: UnionTypeNode) -> dict[str, Any]:
        return {}
